...
public class Regex {
    public static void main(String[] args) {
        ...
        // Provide the pattern
        pattern = Pattern.compile("[a-zA-Z0-9][^knjmndz]{7,}");
        ...
        pattern = Pattern.compile("[a-zA-Z71]{15,}@ymail.com$");
        ...
        // Provide regex pattern
        pattern = Pattern.compile("(https:\\S+|http:\\S+|www\\S))+(kenjimendoza)+(.com|.com|.com.ph|.contact-us)$(?![0-9]/)");
